...
class TheGameViewController: UIViewController {
    ...
    @IBAction func pickUpYourWinningsButtonPressed(_ sender: UIButton) {
        ...
        theGameDelegate?.endTheGame(numberOfQuestions: numberOfQuestions, numberOfCorrectAnswers: numberOfCorrectAnswers, wonAmount: wonAmount, percentageOfAnsweredQuestions: percentageOfAnsweredQuestions, date: Date())
