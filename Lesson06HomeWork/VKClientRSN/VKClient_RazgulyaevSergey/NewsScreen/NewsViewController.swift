...
class NewsViewController: UIViewController {
    ...
    private lazy var networkServiceProxy = NetworkServiceProxy(networkService: networkService)
...
extension NewsViewController {
    fileprivate func setupRefreshControl() {
        refreshControl.attributedTitle = NSAttributedString(string: "Refresh News...", attributes: [.font: UIFont.refreshControlFont])
...
extension NewsViewController {
    func loadPostNewsFromNetwork(completion: (() -> Void)? = nil) {
        networkServiceProxy.loadNews(token: Session.instance.token, typeOfNews: .post, startTime: nil, startFrom: "") { [weak self] result in
            switch result {
