...
class AvailableGroupsViewController: UIViewController {
    ...
    private lazy var refreshControl: UIRefreshControl = {
        ...
        refreshControl.attributedTitle = NSAttributedString(string: "Reload Data", attributes: [.font: UIFont.refreshControlFont])
...
extension AvailableGroupsViewController {
    func loadAvailableGroupsFromNetWork() {
        networkServiceProxy.loadSearchedGroups(token: Session.instance.token, searchedGroupName: searchBar.text!) { [weak self] result in
            switch result {
